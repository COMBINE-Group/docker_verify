$(document).ready(function () {
    ...
    $("#submit_uniquness_analysis").click(function () {
        ...
        $('.divPlot').attr('style', 'visibility: hidden;');
        $('.divPrintPlot').attr('style', 'visibility: hidden;');
        let number_skip_row = $("input[name=number_skip_row_unique_analysis]").val()
        let char_sep = $('select[name=char_sep_unique_analysis]').val();
    ...
    $("#submit_smoothness_analysis").click(function () {
        ...
        $('.divPlot').attr('style', 'visibility: hidden;');
        $('.divPrintPlot').attr('style', 'visibility: hidden;');
        let number_skip_row = $("input[name=number_skip_row_smoothness_analysis]").val()
        let char_sep = $('select[name=char_sep_smoothness_analysis]').val();
    ...
    $("#submit_timestep_analysis").click(function () {
        ...
        $('.divPlot').attr('style', 'visibility: hidden;');
        $('.divPrintPlot').attr('style', 'visibility: hidden;');
        let number_skip_row = $("input[name=number_skip_row]").val()
        let char_sep = $('select[name=char_sep]').val();
